...
export const SKILLS: Skill[] = [
  ...
  // Business
  { id: 'strategy', name: 'Strategy', category: 'Business', proficiency: 5 },
  { id: 'leadership', name: 'Leadership', category: 'Business', proficiency: 5 },
  { id: 'consulting', name: 'Management Consulting', category: 'Business', proficiency: 4 },
  { id: 'finance', name: 'Finance', category: 'Business', proficiency: 4 },
  { id: 'entrepreneurship', name: 'Entrepreneurship', category: 'Business', proficiency: 5 },
